<h2><a href="https://leetcode.com/problems/strange-printer-ii/description/?envType=problem-list-v2&envId=graph">1696. Strange Printer II</a></h2><h3>Hard</h3><hr><p>There is a strange printer with the following two special requirements:</p>
