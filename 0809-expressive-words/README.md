<h2><a href="https://leetcode.com/problems/expressive-words/description/?envType=problem-list-v2&envId=two-pointers">827. Expressive Words</a></h2><h3>Medium</h3><hr><p>Sometimes people repeat letters to represent extra feeling. For example:</p>
